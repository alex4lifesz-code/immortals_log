      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-ink-dark/80 border border-ink-light/40 rounded-lg pl-10 pr-4 py-2 text-sm text-cloud-white placeholder:text-mist-dark/60 outline-none focus:border-jade-glow/60"
          />
        </div>
