...
export default function MobileThemeSettingsPage() {
  return (
    <div>
      <MobileHeader title="Canvas Themes" />
      <section className="mobile-content-stack space-y-4 p-3 pb-24">
        ...
        >
          ...
          <h2 className="mt-2 text-lg font-semibold" style={{ color: "var(--text-primary)" }}>Discord-style color themes</h2>
          <p className="mt-1 text-sm" style={{ color: "var(--text-secondary)" }}>
            Pick from the restored palettes while keeping the same Discord-inspired layout and synced sidebar styling.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>Every option keeps the same canvas behavior and only changes the color palette.</p>
          <div className="mt-4">
            <MobileThemeSelector />
          </div>
        </MobileCard>
